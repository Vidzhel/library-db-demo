...
public class Book
{
    ...
    /// <summary>
    /// Raw JSON metadata string. Use Application layer DTOs for deserialization.
    /// </summary>
    ...
    /// <summary>
    /// Factory method for repository hydration - bypasses validation since data comes from database
    /// </summary>
